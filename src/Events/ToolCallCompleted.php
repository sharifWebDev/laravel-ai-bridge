...
/**
 * Observability hook: ToolCallCompleted. Listen to this via Laravel's Event
...
{
    public function __construct(public readonly string $toolName, public readonly float $durationMs)
    {
    }
}
